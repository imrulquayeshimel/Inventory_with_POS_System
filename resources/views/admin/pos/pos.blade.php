          ...
          <div class="col-lg-6">
                  ...
                  <div class="price_card text-center">
                       ...
                       <div class="pricing-footer bg-primary">
                            ...
                            <p style="font-size: 20px;">Product : {{ Cart::subtotal() }}</p>
                            <p style="font-size: 20px;">Vat : {{ Cart::tax() }}</p>
                            <hr>
                            <p><h2 class="text-white">Total:</h2><h1 class="text-white style="font-size: 20px;"">{{ Cart::total() }}</h1></p>
                       </div>
                                                         ...
                                                         <input type="hidden" name="price" value="{{ $row->selling_price }}">
                                                            <td> 
                                                               {{--  <a href="" style="font-size: 20px"><i class="fas fa-plus-square"></i></a> --}}
                                                                <img src="{{ URL::to($row->product_image)}}" height="80px" width="100px">
                                                            </td>
