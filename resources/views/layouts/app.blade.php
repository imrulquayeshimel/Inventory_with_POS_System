                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fas fa-users"></i><span> Salery(EMP) </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.Advancedsalary') }}">Add Advanced Salery</a></li>
                                     <li><a href="{{ route('all.Advancedsalary') }}">All Advanced Salery</a></li>
                                     <li><a href="{{ route('pay.salary') }}">Pay Salery</a></li>
                                     <li><a href="">Last Month Salery</a></li>
                                </ul>
                            </li> 
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class=fa fa-product-hunt"></i><span> Products </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                             ...
                             <li class="has_sub">
                              ...
                              <li class="has_sub">
                                <a href="#" class=ion-settings"><i class="fas fa-users"></i><span>Settings </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            {{--  <li class="has_sub">
                               <a href="{{ route('setting') }}"><i class="ion-settings"></i>Settings</a>
